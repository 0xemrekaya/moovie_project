...
// A method for inserting a new record in the movies table, param is a pointer,
// so dont need to return the object.
...
// A method for fetching a specific record from the movies table.
...
// A method for updating a specific record in the movies table.
